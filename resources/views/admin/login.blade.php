        ...
        <div id="mws-login">
            ...
            <div id="mws-login-form">
                ...
                <form class="mws-form" action="/admin/dologin" method="post">
                    ...
                    <div class="mws-form-row">
                        <div class="mws-form-item">
                            <input type="text" style='width: 160px' name="code" class="mws-login-password required" placeholder="请输入验证码">

                            <img src="/admin/captcha" alt="" onclick='this.src = this.src+="?1"' style='border-radius:3px'>
